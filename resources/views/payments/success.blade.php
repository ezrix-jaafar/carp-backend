...
<body>
    <div class="success-container">
        ...
        <div class="success-message">
            ...
            <p class="text-gray-600">Thank you for your payment. Your invoice has been marked as paid.</p>
        </div>
        
        <div class="invoice-details mb-6">
            <div class="bg-gray-50 p-4 rounded-lg">
                <p class="font-semibold text-gray-800">Invoice Number: {{ $invoice->invoice_number }}</p>
                <p class="text-gray-700">Amount Paid: RM {{ number_format($invoice->total_amount, 2) }}</p>
                <p class="text-gray-700">Date: {{ now()->format('d M Y H:i:s') }}</p>
            </div>
        </div>
